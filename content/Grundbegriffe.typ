...
== Hypothese
Eine Hypothese ist eine Aussage, abgeleitet aus einer Theorie oder einer Beobachtung. Hypothesen sind nicht so umfangreich wie eine Theorie und stellen eine Vermutung zu einem Sachverhalt auf. Sie sind überprüfbar und können bestätigt bzw. bewiesen werden.
Wissenschaftliche Hypothesen prüfen Zusammenhänge.
== Modell
Modelle sind vereinfachte Darstellungen relevanter Teile der Realität. Die Repräsentation der
Realität durch Modelle ermöglicht eine einfachere Analyse.
== Schlusstechniken
=== Induktion
...
Bei quantitativen Forschungen geht es darum, eine These durch Datenerhebung zu prüfen. Hierbei wird versucht, die Wirklichkeit durch numerische Messungen darzustellen.
Auf den Skalen wird ein Ausschnitt aus den Befragungen abgebildet. Es wird mit Häufigkeiten, Mittelwerten, Wahrscheinlichkeiten des Auftretens von Ausprägungen gearbeitet.
*Beispiele:*
- Online-Umfragen
...
Bei qualitativen Methoden wird versucht, eine Wirklichkeit darzustellen bzw. zu verbalisieren. Wirklichkeitsinterpretationen sind durch spezifische soziale Handlungsweisen geprägt und
strukturieren gleichzeitig das soziale Handeln der Einzelperson vor. Der Untersuchungsgegenstand soll möglichst in seinem natürlichen Umfeld detailliert, ganzheitlich
...
Die Personen werden vollständig zufällig ausgewählt, ohne Kriterien. Jedes Element hat dieselbe
Wahrscheinlichkeit, gezogen zu werden.
=== Klumpenstichprobe (Cluster Sample)
Die Grundgesamtheit wird in Klumpen (Cluster) zerlegt, z. B. nach Filialen oder Stadtteilen. Einige
Klumpen werden zufällig gezogen und darin werden alle Personen befragt.
